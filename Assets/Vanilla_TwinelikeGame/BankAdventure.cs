/*
Generated by UnityTwine on 02/21/2017 13:02:03
...
public class BankAdventure: TwineStory
{
	...
	IEnumerable<TwineOutput> passageExecute_0()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineText(@"It is a piece of paper, a piece of paper with '");yield return new TwineLink(@"go to the bank", @"go to the bank", @"go to the bank", null, null);yield return new TwineText(@"' written on it.");	
	}
	...
	IEnumerable<TwineOutput> passageExecute_6()
	{
		...
		yield return new TwineText(@"It shows how to ");yield return new TwineLink(@"get to the bank", @"get to the bank", @"get to the bank", null, null);yield return new TwineText(@".");	
	}
	...
	IEnumerable<TwineOutput> passageExecute_7()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"Talk to her]]
		[[Ignore", @"Talk to her]]
		[[Ignore", @"get to the bank", null, null);	
	}
	...
	IEnumerable<TwineOutput> passageExecute_9()
	{
		...
		yield return new TwineText(@"");
		yield return new TwineLink(@"Bring her to the bank together]]
		[[Leave", @"Bring her to the bank together]]
		[[Leave", @"get to the bank", null, null);	
	}
